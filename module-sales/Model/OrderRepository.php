...
class OrderRepository implements \Magento\Sales\Api\OrderRepositoryInterface
{
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria)
    {
        ...
        foreach ($searchResult->getItems() as $order) {
            //code change starts from here
            $extensionAttributes = $this->orderItemExtension->create(); //added dependency of orderItemExtension
            $extensionAttributes->setData('pgstatus', $order->getData('pgstatus'));
            $order->setShipingData($extensionAttributes);
